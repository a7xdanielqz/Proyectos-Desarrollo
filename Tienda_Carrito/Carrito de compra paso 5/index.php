...
<?php
    $busqueda=mysqli_query($conexion,"SELECT * FROM programaciononline.datos_usuario_cp ORDER BY RAND() LIMIT 1");
...
<input type="hidden" name="dato" value="insertar" >
  ...
  <div class="col-md-6">
    ...
    <input type="text" class="form-control" id="validationCustom03" name="localidad" value="<?php echo $resultado["localidad"]; ?>"  required>
    <div class="valid-feedback">
    Correcto!
    </div>
      <div class="invalid-feedback">
