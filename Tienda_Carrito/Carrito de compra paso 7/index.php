...
<div class="center mt-5">
    <div class="card pt-3" >
        ...
        <div class="container-fluid p-2">
                ...
                <?php
                $busqueda=mysqli_query($conexion,"SELECT t.ref, t.estado, t.medio, t.total, t2.cantidad, t2.articulo, t2.precio, t2.total AS 'total_precio', t3.nombre, t3.apellidos, t3.localidad, t3.telefono
                ...
                ?>
                        ...
                        while ($resultado = mysqli_fetch_assoc($busqueda)){
                            ...
                            define('dato_localidad', $resultado["localidad"]);
